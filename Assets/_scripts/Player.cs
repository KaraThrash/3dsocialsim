...
public class Player : MonoBehaviour
{
    ...
    public void State(PlayerState _state)
    { OnStateChange(_state); state = _state; }
    ...
    public void WorldLocation(WorldLocation _location)
    ...
    public void EndFish()
    {
        ...
        // CatchBug(); State(PlayerState.playerControlled);
    }
    ...
    public void RollEyes()
    {
        ...
        // =
        // leftEyeMaterial;
        // leftEyeMaterial.SetTexture("Texture2D_72426835",
        // eyesLeft[count]);
    ...
    public void MoveNavmesh(float _speed = 5, float _minagle = 15)
    {
        ...
        {
            // SetNavMeshSpeed(Mathf.Lerp(nav.speed,
            // _speed,
            // Time.deltaTime
            // * acceleration));
            SetNavMeshSpeed(_speed);
